package br.com.mili.milibackend.infra.security.repository;

import br.com.mili.milibackend.infra.security.repository.dummy.AuthDummy;
import br.com.mili.milibackend.infra.security.repository.projections.SystemAuthProjection;
    ...
    @Query(value = """
        ...
        FROM (                         
            ...
            WHERE
                ...
                AND B.CTSIS_CODIGO IN (39, 38, 53, 65)
            ...
            WHERE
                A.CTUSU_CODIGO IN (
                    ...
                    WHERE
                        ...
                        AND C.CTSIS_CODIGO IN (39, 38, 53, 65)
                )
                AND B.CTSIS_CODIGO IN (39, 38, 53, 65)
                AND A.CTUSU_CODIGO = B.CTUSU_CODIGO
                AND B.CTSIS_CODIGO = C.CTSIS_CODIGO
